...
export const AGGREGATE_EVENT_UPCASTERS_METADATA_KEY = 'AGGREGATE_EVENT_UPCASTERS';
...
export const PROJECTION_EVENT_UPCASTERS_METADATA_KEY = 'PROJECTION_EVENT_UPCASTERS';
