...
export interface CustomPinInputFieldProps extends UseFormRegisterReturn {
  numberOfFields?: number;
  chakraPinInputProps?: Omit<PinInputProps, 'children'>;
  errorMsg?: string | undefined;
}

const CustomPinInputField = forwardRef<
  HTMLInputElement,
...
CustomPinInputField.displayName = 'CustomPinInputField';
